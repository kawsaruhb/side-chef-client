...
const ChefsCard = ({ chefs }) => {
    ...
    return (
        <div>
            <div className="card w-80 p-4 glass bg-red-100">
                <figure><img className='w-full h-68 rounded-lg' src={chef_img} alt="car!" /></figure>
                <div className="mt-2">
                    ...
                    <div className="card-actions justify-end">
                        <Link to={`/chef-detail/${_id}`}><button className="btn btn-error font-bold border-none w-full">Recipes</button></Link>
                    </div>
                </div>
            </div>
        </div>
